...
public class VehicleService : IVehicleService
{
    ...
    public async Task DeleteVehicleAsync(int id, int userId)
    {
        ...
        // Soft delete — marks vehicle as deleted. The global query filter
        // (HasQueryFilter(v => !v.IsDeleted)) automatically hides it from all queries.
        // Child records (fuel entries, service records, etc.) are preserved for audit history.
